...
class HoldingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holding" do
    assert_difference('Holding.count') do
      post holdings_url, params: { holding: { active: @holding.active, name: @holding.name } }
    end
  ...
  test "should update holding" do
    patch holding_url(@holding), params: { holding: { active: @holding.active, name: @holding.name } }
